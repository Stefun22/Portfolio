...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      // "https://media.tenor.com/7hXcYAbcWs4AAAAi/color-smoke.gif"))),
      child: Scaffold(
        appBar: NavBar(),
                              ...
                              (e) => Padding(
                                ...
                                child: HoverCard(
                                  child: SizedBox(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsets.fromLTRB(10.adjust(),
                                          3.adjust(), 10.adjust(), 3.adjust()),
                                      child: Column(
                                          crossAxisAlignment:
  ...
  final List<Map<String, String>> skillsSetData = [
    ...
    },
    {
      ...
      "data":
          "Expertise in state management solutions like Provider, Riverpod, and Bloc.",
      "image":
